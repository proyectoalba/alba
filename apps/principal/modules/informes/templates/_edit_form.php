<?php
echo form_tag('informes/save', array(
...
<fieldset id="sf_fieldset_informacion_general" class="">
  <div class="form-row">
    ...
    <div class="content<?php if ($sf_request->hasError('informe{nombre}')): ?> form-error<?php endif; ?>">
      ...
      <?php
      $value = object_input_tag($informe, 'getNombre', array(
          'size' => 64,
  ...
  <div class="form-row">
    ...
    <div class="content<?php if ($sf_request->hasError('informe{descripcion}')): ?> form-error<?php endif; ?>">
      ...
      <?php
      $value = object_input_tag($informe, 'getdescripcion', array(
          'size' => 64,
  ...
  <div class="form-row">
    ...
    <div class="content<?php if ($sf_request->hasError('informe{fk_tipoinforme_id}')): ?> form-error<?php endif; ?>">
      ...
      <?php
      $value = object_select_tag($informe, 'getFkTipoinformeId', array(
  ...
  <div class="form-row">
    ...
    <div class="content<?php if ($sf_request->hasError('informe{listado}')): ?> form-error<?php endif; ?>">
      ...
      <?php
      $value = object_checkbox_tag($informe, 'getListado', array(
  ...
  <div class="form-row">
    ...
    <div class="content<?php if ($sf_request->hasError('informe{variables}')): ?> form-error<?php endif; ?>">
      ...
      <?php
      $value = object_input_tag($informe, 'getVariables', array(
          'size' => 64,
          'control_name' => 'informe[variables]',
              ));
      echo $value ? $value : '&nbsp;'
      ?><?php echo link_to(image_tag('small/help.png', array('alt'=> 'Ayuda', 'title'=>'Ayuda sobre las variables')),'informes/ayuda')?>
    </div>
  </div>
