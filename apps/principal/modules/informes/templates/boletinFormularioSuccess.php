...
?>
  <tr class="sf_admin_row_0">
    ...
    <ul class="sf_admin_td_actions">
     <li><?php echo link_to(image_tag('/images/small/report_go.png', array('alt' => 'editar', 'title' => 'Editar')) , 'informes?action=boletinListado&alumno_id='.$alumno->alumno_id."&division_id=".$alumno->division_id); ?></li>
    </ul>
    </td>
  </tr>
  <?php } ?>
