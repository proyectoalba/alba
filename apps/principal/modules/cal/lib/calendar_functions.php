...
//					  returned.
function availableCalendars($username, $password, $cal_filename, $admin = false,$globals=null) {
	// Import globals.
// 	global $allow_webcals, $allow_login, $calendar_path, $recursive_path, $support_ical, $blacklisted_cals, $list_webcals, $locked_cals, $locked_map, $apache_map, $lang, $ALL_CALENDARS_COMBINED, $_SERVER;
	...
	$allow_webcals = $globals['allow_webcals'];
	$allow_login = $globals['allow_login'];
	$calendar_path = $globals['calendar_path'];
	$recursive_path = $globals['recursive_path'];
	$support_ical = $globals['support_ical'];
	$blacklisted_cals = $globals['blacklisted_cals'];
	$list_webcals = $globals['list_webcals'];
	$locked_cal = $globals['locked_cal'];
	$locked_map = $globals['locked_map'];
	$apache_map = $globals['apache_map'];
	$lang = $globals['lang'];
	$ALL_CALENDARS_COMBINED = $globals['ALL_CALENDARS_COMBINED'];
