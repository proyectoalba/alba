...
<table border="0" width="520" cellspacing="0" cellpadding="0" class="calborder">
	...
	<tr>
		<td class="dayborder"><img src="{BASE}/images/spacer.gif" width="1" height="1" alt=" "></td>
	</tr>
	<tr>
		<td align="left">
			<div style="padding: 10px;">
				...
				<!-- switch results on -->
				<font class="V12"><b><a class="ps3" href="{DAY_VIEW_ACTION}/date/{KEY}">{DAYOFMONTH}</a></b></font><br />
				...
				<font class="V10"><i>{L_EXCEPTION}</i>: <a class="ps3" href="{DAY_VIEW_ACTION}/date/{KEY}">{DAYOFMONTH}</a></font><br />
