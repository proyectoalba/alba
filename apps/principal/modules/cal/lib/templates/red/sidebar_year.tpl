...
<img src="{BASE}/images/spacer.gif" width="1" height="10" alt=" " /><br />
<!-- switch show_user_login off -->
<table width="170" border="0" cellpadding="0" cellspacing="0" class="calborder">
	<tr>
		<td align="left" valign="top" width="24" class="sideback"><a class="psf" href="{DAY_VIEW_ACTION}/date/{PREV_DAY}"><img src="{BASE}/templates/{TEMPLATE}/images/left_arrows.gif" alt="{L_PREV}" width="16" height="20" border="0" align="left" /></a></td>
		<td align="center" width="112" class="sideback"><font class="G10BOLD">{SIDEBAR_DATE}</font></td>
		<td align="right" valign="top" width="24" class="sideback"><a class="psf" href="{DAY_VIEW_ACTION}/date/{NEXT_DAY}"><img src="{BASE}/templates/{TEMPLATE}/images/right_arrows.gif" alt="{L_NEXT}" width="16" height="20" border="0" align="right" /></a></td>
	</tr>
	<tr>
		...
		<td bgcolor="#FFFFFF" align="left">
			<div style="padding: 5px;">
				<table cellpadding="0" cellspacing="0" border="0">
					...
					<tr>
						<td><img src="{BASE}/images/completed.gif" alt=" " width="13" height="11" border="0" align="middle" /></td>
						<td><img src="{BASE}/images/spacer.gif" width="2" height="1" border="0" alt="" /></td>
						<td><s>{VTODO_ARRAY}<font class="G10B"> {VTODO_TEXT}</font></a></s></td>
					</tr>
					<!-- switch show_completed off -->
					<!-- switch show_important on -->
					<tr>
						<td><img src="{BASE}/images/important.gif" alt=" " width="13" height="11" border="0" align="middle" /></td>
						<td><img src="{BASE}/images/spacer.gif" width="2" height="1" border="0" alt="" /></td>
					...
					<tr>
						<td><img src="{BASE}/images/not_completed.gif" alt=" " width="13" height="11" border="0" align="middle" /></td>
						<td><img src="{BASE}/images/spacer.gif" width="2" height="1" border="0" alt="" /></td>
						<td>{VTODO_ARRAY}<font class="G10B"> {VTODO_TEXT}</font></a></td>
					</tr>
