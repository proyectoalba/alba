...
<?php echo form_tag('relAlumnoDivision/save', array(
...
function filrarAlumnosSinDivision(sin_division)
{
  new Ajax.Updater(
    ...
    {asynchronous:true, evalScripts:false, parameters: { sin_division: sin_division } }
  );
}
");
?>
...
<div class="form-row">
  ...
  <?php $value = object_select_tag($rel_alumno_division, 'getFkAlumnoId', array (
...
<div class="form-row">
  ...
  <?php $value = get_partial('fk_division_id', array('type' => 'edit', 'rel_alumno_division' => $rel_alumno_division)); echo $value ? $value : '&nbsp;' ?>
    </div>
</div>
...
<?php echo button_to(__('delete'), 'relAlumnoDivision/delete?id='.$rel_alumno_division->getId(), array (
  'post' => true,
