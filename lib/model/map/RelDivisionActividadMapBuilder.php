...
/**
 * This class adds structure of 'rel_division_actividad' table to 'alba' DatabaseMap object.
 *
 *
 *
 ...
 * @package model.map
 */	
class RelDivisionActividadMapBuilder {

	/**
	 * The (dot-path) name of this class
	 */
	const CLASS_NAME = 'model.map.RelDivisionActividadMapBuilder';	
    ...
    public function doBuild()
    {
		...
		$tMap = $this->dbMap->addTable('rel_division_actividad');
		$tMap->setPhpName('RelDivisionActividad');
...
} // RelDivisionActividadMapBuilder
