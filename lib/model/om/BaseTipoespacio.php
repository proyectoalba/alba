...
abstract class BaseTipoespacio extends BaseObject  implements Persistent {
  ...
  const PEER = 'TipoespacioPeer';
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TipoespacioPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			TipoespacioPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
		...
		if ($this->collEspacios === null) {
			if ($this->isNew()) {
			   $this->collEspacios = array();
				...
				$criteria->add(EspacioPeer::FK_TIPOESPACIO_ID, $this->id);
	...
	public function getEspaciosJoinLocacion($criteria = null, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		if ($criteria === null) {
			$criteria = new Criteria(TipoespacioPeer::DATABASE_NAME);
		}
		...
		if ($this->collEspacios === null) {
			if ($this->isNew()) {
				...
				$this->collEspacios = EspacioPeer::doSelectJoinLocacion($criteria, $con, $join_behavior);
			}
		} else {
