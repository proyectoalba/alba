...
abstract class BaseOrientacionPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new OrientacionMapBuilder();
		}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
				$criteria = clone $criteria;
								...
								$criteria->setPrimaryTableName(OrientacionPeer::TABLE_NAME);
	...
	{
		return OrientacionPeer::populateObjects(OrientacionPeer::doSelectStmt($criteria, $con));
	}
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Orientacion) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
								$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Orientacion object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = substr('.'.$cls, strrpos('.'.$cls, '.') + 1);
			...
			$key = OrientacionPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = OrientacionPeer::getInstanceFromPool($key))) {
																$results[] = $obj;
			} else {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				OrientacionPeer::addInstanceToPool($obj, $key);
			} 		}
		$stmt->closeCursor();
		return $results;
	}
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(OrientacionPeer::ID) && $criteria->keyContainsValue(OrientacionPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.OrientacionPeer::ID.')');
		}
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
												OrientacionPeer::clearInstancePool();

						$criteria = clone $values;
		} elseif ($values instanceof Orientacion) {
						OrientacionPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
								OrientacionPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = OrientacionPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
Propel::getDatabaseMap(BaseOrientacionPeer::DATABASE_NAME)->addTableBuilder(BaseOrientacionPeer::TABLE_NAME, BaseOrientacionPeer::getMapBuilder());
