...
abstract class BaseTipoasistenciaPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nombre', 'descripcion', 'valor', 'grupo', 'defecto', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NOMBRE, self::DESCRIPCION, self::VALOR, self::GRUPO, self::DEFECTO, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nombre' => 1, 'descripcion' => 2, 'valor' => 3, 'grupo' => 4, 'defecto' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NOMBRE => 1, self::DESCRIPCION => 2, self::VALOR => 3, self::GRUPO => 4, self::DEFECTO => 5, ),
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new TipoasistenciaMapBuilder();
		}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
				$criteria = clone $criteria;
								...
								$criteria->setPrimaryTableName(TipoasistenciaPeer::TABLE_NAME);
	...
	public static function addInstanceToPool(Tipoasistencia $obj, $key = null)
	{
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Tipoasistencia) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
								$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Tipoasistencia object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = substr('.'.$cls, strrpos('.'.$cls, '.') + 1);
			...
			$key = TipoasistenciaPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = TipoasistenciaPeer::getInstanceFromPool($key))) {
																$results[] = $obj;
			} else {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				TipoasistenciaPeer::addInstanceToPool($obj, $key);
			} 		}
		$stmt->closeCursor();
		return $results;
	}
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(TipoasistenciaPeer::ID) && $criteria->keyContainsValue(TipoasistenciaPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.TipoasistenciaPeer::ID.')');
		}
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
												TipoasistenciaPeer::clearInstancePool();

						$criteria = clone $values;
		} elseif ($values instanceof Tipoasistencia) {
						TipoasistenciaPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
								TipoasistenciaPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = TipoasistenciaPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
Propel::getDatabaseMap(BaseTipoasistenciaPeer::DATABASE_NAME)->addTableBuilder(BaseTipoasistenciaPeer::TABLE_NAME, BaseTipoasistenciaPeer::getMapBuilder());
