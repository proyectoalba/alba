...
abstract class BaseRolPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new RolMapBuilder();
		}
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(RolPeer::ACTIVO);
	...
	public static function addInstanceToPool(Rol $obj, $key = null)
	{
...
Propel::getDatabaseMap(BaseRolPeer::DATABASE_NAME)->addTableBuilder(BaseRolPeer::TABLE_NAME, BaseRolPeer::getMapBuilder());
