...
abstract class BaseTipoinformePeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new TipoinformeMapBuilder();
		}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
				$criteria = clone $criteria;
								...
								$criteria->setPrimaryTableName(TipoinformePeer::TABLE_NAME);
	...
	{
		return TipoinformePeer::populateObjects(TipoinformePeer::doSelectStmt($criteria, $con));
	}
	...
	public static function addInstanceToPool(Tipoinforme $obj, $key = null)
	{
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Tipoinforme) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
								$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Tipoinforme object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = substr('.'.$cls, strrpos('.'.$cls, '.') + 1);
			...
			$key = TipoinformePeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = TipoinformePeer::getInstanceFromPool($key))) {
																$results[] = $obj;
			} else {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				TipoinformePeer::addInstanceToPool($obj, $key);
			} 		}
		$stmt->closeCursor();
		return $results;
	}
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(TipoinformePeer::ID) && $criteria->keyContainsValue(TipoinformePeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.TipoinformePeer::ID.')');
		}
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
												TipoinformePeer::clearInstancePool();

						$criteria = clone $values;
		} elseif ($values instanceof Tipoinforme) {
						TipoinformePeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
								TipoinformePeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = TipoinformePeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
Propel::getDatabaseMap(BaseTipoinformePeer::DATABASE_NAME)->addTableBuilder(BaseTipoinformePeer::TABLE_NAME, BaseTipoinformePeer::getMapBuilder());
