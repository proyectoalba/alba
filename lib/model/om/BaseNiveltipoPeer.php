...
abstract class BaseNiveltipoPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new NiveltipoMapBuilder();
		}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
				$criteria = clone $criteria;
								...
								$criteria->setPrimaryTableName(NiveltipoPeer::TABLE_NAME);
	...
	{
		return NiveltipoPeer::populateObjects(NiveltipoPeer::doSelectStmt($criteria, $con));
	}
	...
	public static function addInstanceToPool(Niveltipo $obj, $key = null)
	{
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Niveltipo) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
								$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Niveltipo object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = substr('.'.$cls, strrpos('.'.$cls, '.') + 1);
			...
			$key = NiveltipoPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = NiveltipoPeer::getInstanceFromPool($key))) {
																$results[] = $obj;
			} else {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				NiveltipoPeer::addInstanceToPool($obj, $key);
			} 		}
		$stmt->closeCursor();
		return $results;
	}
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(NiveltipoPeer::ID) && $criteria->keyContainsValue(NiveltipoPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.NiveltipoPeer::ID.')');
		}
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
												NiveltipoPeer::clearInstancePool();

						$criteria = clone $values;
		} elseif ($values instanceof Niveltipo) {
						NiveltipoPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
								NiveltipoPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = NiveltipoPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
Propel::getDatabaseMap(BaseNiveltipoPeer::DATABASE_NAME)->addTableBuilder(BaseNiveltipoPeer::TABLE_NAME, BaseNiveltipoPeer::getMapBuilder());
