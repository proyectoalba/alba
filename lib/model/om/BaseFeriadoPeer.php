...
abstract class BaseFeriadoPeer {
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$rs = FeriadoPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
						return 0;
	...
	public static function doCountJoinCiclolectivo(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(FeriadoPeer::FK_CICLOLECTIVO_ID, CiclolectivoPeer::ID);
	...
	public static function doSelectJoinCiclolectivo(Criteria $c, $con = null)
	{
		...
		$startcol = (FeriadoPeer::NUM_COLUMNS - FeriadoPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		CiclolectivoPeer::addSelectColumns($c);

		$c->addJoin(FeriadoPeer::FK_CICLOLECTIVO_ID, CiclolectivoPeer::ID);
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		FeriadoPeer::addSelectColumns($c);
		$startcol2 = (FeriadoPeer::NUM_COLUMNS - FeriadoPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
