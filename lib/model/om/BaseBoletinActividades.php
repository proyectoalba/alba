...
abstract class BaseBoletinActividades extends BaseObject  implements Persistent {
  ...
  const PEER = 'BoletinActividadesPeer';
	...
	{
						if (array_diff($this->modifiedColumns, array(BoletinActividadesPeer::FK_ALUMNO_ID,BoletinActividadesPeer::FK_ACTIVIDAD_ID,BoletinActividadesPeer::FK_PERIODO_ID))) {
				return false;
			}
	...
	public function hydrate($row, $startcol = 0, $rehydrate = false)
	{
		try {
			...
			$this->observacion = $row[$startcol + 5];
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = BoletinActividadesPeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			BoletinActividadesPeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
