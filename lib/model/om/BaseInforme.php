...
abstract class BaseInforme extends BaseObject  implements Persistent {
	...
	public function hydrate(ResultSet $rs, $startcol = 1)
	{
		try {
			...
			$this->fk_adjunto_id = $rs->getInt($startcol + 3);

			$this->fk_tipoinforme_id = $rs->getInt($startcol + 4);

			$this->listado = $rs->getBoolean($startcol + 5);
	...
	public function getTipoinforme($con = null)
	{
				include_once 'lib/model/om/BaseTipoinformePeer.php';

		if ($this->aTipoinforme === null && ($this->fk_tipoinforme_id !== null)) {

			$this->aTipoinforme = TipoinformePeer::retrieveByPK($this->fk_tipoinforme_id, $con);
