...
abstract class BaseEscalanotaPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'fkEstablecimientoId', 'nombre', 'descripcion', 'orden', 'aprobado', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::FK_ESTABLECIMIENTO_ID, self::NOMBRE, self::DESCRIPCION, self::ORDEN, self::APROBADO, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'fkEstablecimientoId' => 1, 'nombre' => 2, 'descripcion' => 3, 'orden' => 4, 'aprobado' => 5, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::FK_ESTABLECIMIENTO_ID => 1, self::NOMBRE => 2, self::DESCRIPCION => 3, self::ORDEN => 4, self::APROBADO => 5, ),
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new EscalanotaMapBuilder();
		}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
				$criteria = clone $criteria;
								...
								$criteria->setPrimaryTableName(EscalanotaPeer::TABLE_NAME);
	...
	{
		return EscalanotaPeer::populateObjects(EscalanotaPeer::doSelectStmt($criteria, $con));
	}
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Escalanota) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
								$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Escalanota object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = substr('.'.$cls, strrpos('.'.$cls, '.') + 1);
			...
			$key = EscalanotaPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = EscalanotaPeer::getInstanceFromPool($key))) {
																$results[] = $obj;
			} else {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				EscalanotaPeer::addInstanceToPool($obj, $key);
			} 		}
		$stmt->closeCursor();
		return $results;
	}
	...
	public static function doCountJoinEstablecimiento(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(EscalanotaPeer::FK_ESTABLECIMIENTO_ID,), array(EstablecimientoPeer::ID,), $join_behavior);
	...
	public static function doSelectJoinEstablecimiento(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$startcol = (EscalanotaPeer::NUM_COLUMNS - EscalanotaPeer::NUM_LAZY_LOAD_COLUMNS);
		EstablecimientoPeer::addSelectColumns($c);

		$c->addJoin(array(EscalanotaPeer::FK_ESTABLECIMIENTO_ID,), array(EstablecimientoPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();

		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = EscalanotaPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = EscalanotaPeer::getInstanceFromPool($key1))) {
															} else {
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				EscalanotaPeer::addInstanceToPool($obj1, $key1);
			} 
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		EscalanotaPeer::addSelectColumns($c);
		$startcol2 = (EscalanotaPeer::NUM_COLUMNS - EscalanotaPeer::NUM_LAZY_LOAD_COLUMNS);
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(EscalanotaPeer::ID) && $criteria->keyContainsValue(EscalanotaPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.EscalanotaPeer::ID.')');
		}
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
												EscalanotaPeer::clearInstancePool();

						$criteria = clone $values;
		} elseif ($values instanceof Escalanota) {
						EscalanotaPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
								EscalanotaPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = EscalanotaPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
Propel::getDatabaseMap(BaseEscalanotaPeer::DATABASE_NAME)->addTableBuilder(BaseEscalanotaPeer::TABLE_NAME, BaseEscalanotaPeer::getMapBuilder());
