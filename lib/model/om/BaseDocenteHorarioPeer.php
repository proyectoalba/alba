...
abstract class BaseDocenteHorarioPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('fkDocenteId', 'fkEventoId', ),
		BasePeer::TYPE_COLNAME => array (self::FK_DOCENTE_ID, self::FK_EVENTO_ID, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('fkDocenteId' => 0, 'fkEventoId' => 1, ),
		BasePeer::TYPE_COLNAME => array (self::FK_DOCENTE_ID => 0, self::FK_EVENTO_ID => 1, ),
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof DocenteHorario) {
				$key = serialize(array((string) $value->getFkDocenteId(), (string) $value->getFkEventoId()));
	...
	public static function doCountJoinEvento(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(DocenteHorarioPeer::FK_EVENTO_ID,), array(EventoPeer::ID,), $join_behavior);
	...
	public static function doSelectJoinEvento(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$c->addJoin(array(DocenteHorarioPeer::FK_EVENTO_ID,), array(EventoPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		EventoPeer::addSelectColumns($c);
		$startcol4 = $startcol3 + (EventoPeer::NUM_COLUMNS - EventoPeer::NUM_LAZY_LOAD_COLUMNS);
		...
		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			...
			$key3 = EventoPeer::getPrimaryKeyHashFromRow($row, $startcol3);
			if ($key3 !== null) {
				$obj3 = EventoPeer::getInstanceFromPool($key3);
				if (!$obj3) {
					...
					EventoPeer::addInstanceToPool($obj3, $key3);
				} 
  ...
  static public function getUniqueColumnNames()
  {
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
			...
			foreach ($values as $value) {
				...
				$criterion = $criteria->getNewCriterion(DocenteHorarioPeer::FK_DOCENTE_ID, $value[0]);
				$criterion->addAnd($criteria->getNewCriterion(DocenteHorarioPeer::FK_EVENTO_ID, $value[1]));
				$criteria->addOr($criterion);

								DocenteHorarioPeer::removeInstanceFromPool($value);
			}
		}
	...
	public static function retrieveByPK($fk_docente_id, $fk_evento_id, PropelPDO $con = null) {
		$key = serialize(array((string) $fk_docente_id, (string) $fk_evento_id));
 		if (null !== ($obj = DocenteHorarioPeer::getInstanceFromPool($key))) {
 			return $obj;
		}
