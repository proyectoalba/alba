...
abstract class BasePermisoPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_FIELDNAME => array ('id', 'nombre', 'descripcion', 'fk_modulo_id', 'credencial', ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nombre' => 1, 'descripcion' => 2, 'fk_modulo_id' => 3, 'credencial' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(PermisoPeer::FK_MODULO_ID);

		$criteria->addSelectColumn(PermisoPeer::CREDENCIAL);
	...
	public static function doCountJoinModulo(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(PermisoPeer::FK_MODULO_ID, ModuloPeer::ID);
	...
	public static function doSelectJoinModulo(Criteria $c, $con = null)
	{
		...
		ModuloPeer::addSelectColumns($c);

		$c->addJoin(PermisoPeer::FK_MODULO_ID, ModuloPeer::ID);
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		ModuloPeer::addSelectColumns($c);
		$startcol3 = $startcol2 + ModuloPeer::NUM_COLUMNS;
