...
abstract class BaseTipodocente extends BaseObject  implements Persistent {
  ...
  const PEER = 'TipodocentePeer';
	...
	public function reload($deep = false, PropelPDO $con = null)
	{
		...
		$stmt = TipodocentePeer::doSelectStmt($this->buildPkeyCriteria(), $con);
	...
	public function delete(PropelPDO $con = null)
	{
		...
		try {
			TipodocentePeer::doDelete($this, $con);
	...
	public function save(PropelPDO $con = null)
	{
		...
		try {
			...
			$con->commit();
			TipodocentePeer::addInstanceToPool($this);
			return $affectedRows;
		} catch (PropelException $e) {
			$con->rollBack();
			throw $e;
	...
	protected function doValidate($columns = null)
	{
		if (!$this->alreadyInValidation) {
			...
			if (($retval = TipodocentePeer::doValidate($this, $columns)) !== true) {
	...
	public function buildCriteria()
	{
		...
		if ($this->isColumnModified(TipodocentePeer::ID)) $criteria->add(TipodocentePeer::ID, $this->id);
		if ($this->isColumnModified(TipodocentePeer::NOMBRE)) $criteria->add(TipodocentePeer::NOMBRE, $this->nombre);
		if ($this->isColumnModified(TipodocentePeer::DESCRIPCION)) $criteria->add(TipodocentePeer::DESCRIPCION, $this->descripcion);
	...
	public function buildPkeyCriteria()
	{
		...
		$criteria->add(TipodocentePeer::ID, $this->id);
