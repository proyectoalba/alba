...
abstract class BaseProvinciaPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nombreCorto', 'nombreLargo', 'fkPaisId', 'orden', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NOMBRE_CORTO, self::NOMBRE_LARGO, self::FK_PAIS_ID, self::ORDEN, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nombreCorto' => 1, 'nombreLargo' => 2, 'fkPaisId' => 3, 'orden' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NOMBRE_CORTO => 1, self::NOMBRE_LARGO => 2, self::FK_PAIS_ID => 3, self::ORDEN => 4, ),
	...
	public static function doCountJoinPais(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(ProvinciaPeer::FK_PAIS_ID,), array(PaisPeer::ID,), $join_behavior);
	...
	public static function doSelectJoinPais(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$startcol = (ProvinciaPeer::NUM_COLUMNS - ProvinciaPeer::NUM_LAZY_LOAD_COLUMNS);
		PaisPeer::addSelectColumns($c);

		$c->addJoin(array(ProvinciaPeer::FK_PAIS_ID,), array(PaisPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();

		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = ProvinciaPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = ProvinciaPeer::getInstanceFromPool($key1))) {
															} else {
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				ProvinciaPeer::addInstanceToPool($obj1, $key1);
			} 
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ProvinciaPeer::addSelectColumns($c);
		$startcol2 = (ProvinciaPeer::NUM_COLUMNS - ProvinciaPeer::NUM_LAZY_LOAD_COLUMNS);
