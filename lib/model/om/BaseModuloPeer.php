...
abstract class BaseModuloPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_FIELDNAME => array ('id', 'nombre', 'titulo', 'descripcion', 'activo', ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_FIELDNAME => array ('id' => 0, 'nombre' => 1, 'titulo' => 2, 'descripcion' => 3, 'activo' => 4, ),
		BasePeer::TYPE_NUM => array (0, 1, 2, 3, 4, )
	);
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ModuloPeer::ID);

		$criteria->addSelectColumn(ModuloPeer::NOMBRE);

		$criteria->addSelectColumn(ModuloPeer::TITULO);

		$criteria->addSelectColumn(ModuloPeer::DESCRIPCION);

		$criteria->addSelectColumn(ModuloPeer::ACTIVO);
	...
	public static function doCount(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$rs = ModuloPeer::doSelectRS($criteria, $con);
		if ($rs->next()) {
			return $rs->getInt(1);
		} else {
	...
	public static function doValidate(Modulo $obj, $cols = null)
	{
		...
		$res =  BasePeer::doValidate(ModuloPeer::DATABASE_NAME, ModuloPeer::TABLE_NAME, $columns);
    if ($res !== true) {
        $request = sfContext::getInstance()->getRequest();
        foreach ($res as $failed) {
            $col = ModuloPeer::translateFieldname($failed->getColumn(), BasePeer::TYPE_COLNAME, BasePeer::TYPE_PHPNAME);
	...
	public static function retrieveByPKs($pks, $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria->add(ModuloPeer::ID, $pks, Criteria::IN);
