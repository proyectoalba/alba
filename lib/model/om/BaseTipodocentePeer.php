...
abstract class BaseTipodocentePeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new TipodocenteMapBuilder();
		}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
				$criteria = clone $criteria;
								...
								$criteria->setPrimaryTableName(TipodocentePeer::TABLE_NAME);
	...
	{
		return TipodocentePeer::populateObjects(TipodocentePeer::doSelectStmt($criteria, $con));
	}
	...
	public static function addInstanceToPool(Tipodocente $obj, $key = null)
	{
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Tipodocente) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
								$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Tipodocente object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = substr('.'.$cls, strrpos('.'.$cls, '.') + 1);
			...
			$key = TipodocentePeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = TipodocentePeer::getInstanceFromPool($key))) {
																$results[] = $obj;
			} else {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				TipodocentePeer::addInstanceToPool($obj, $key);
			} 		}
		$stmt->closeCursor();
		return $results;
	}
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = TipodocentePeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
Propel::getDatabaseMap(BaseTipodocentePeer::DATABASE_NAME)->addTableBuilder(BaseTipodocentePeer::TABLE_NAME, BaseTipodocentePeer::getMapBuilder());
