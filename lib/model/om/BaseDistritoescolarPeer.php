...
abstract class BaseDistritoescolarPeer {
	...
	private static $fieldNames = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id', 'nombre', 'direccion', 'telefono', 'ciudad', ),
		BasePeer::TYPE_COLNAME => array (self::ID, self::NOMBRE, self::DIRECCION, self::TELEFONO, self::CIUDAD, ),
	...
	private static $fieldKeys = array (
		...
		BasePeer::TYPE_STUDLYPHPNAME => array ('id' => 0, 'nombre' => 1, 'direccion' => 2, 'telefono' => 3, 'ciudad' => 4, ),
		BasePeer::TYPE_COLNAME => array (self::ID => 0, self::NOMBRE => 1, self::DIRECCION => 2, self::TELEFONO => 3, self::CIUDAD => 4, ),
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new DistritoescolarMapBuilder();
		}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
				$criteria = clone $criteria;
								...
								$criteria->setPrimaryTableName(DistritoescolarPeer::TABLE_NAME);
	...
	{
		return DistritoescolarPeer::populateObjects(DistritoescolarPeer::doSelectStmt($criteria, $con));
	}
	...
	public static function addInstanceToPool(Distritoescolar $obj, $key = null)
	{
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Distritoescolar) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
								$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Distritoescolar object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = substr('.'.$cls, strrpos('.'.$cls, '.') + 1);
			...
			$key = DistritoescolarPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = DistritoescolarPeer::getInstanceFromPool($key))) {
																$results[] = $obj;
			} else {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				DistritoescolarPeer::addInstanceToPool($obj, $key);
			} 		}
		$stmt->closeCursor();
		return $results;
	}
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(DistritoescolarPeer::ID) && $criteria->keyContainsValue(DistritoescolarPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.DistritoescolarPeer::ID.')');
		}
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
												DistritoescolarPeer::clearInstancePool();

						$criteria = clone $values;
		} elseif ($values instanceof Distritoescolar) {
						DistritoescolarPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
								DistritoescolarPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = DistritoescolarPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
Propel::getDatabaseMap(BaseDistritoescolarPeer::DATABASE_NAME)->addTableBuilder(BaseDistritoescolarPeer::TABLE_NAME, BaseDistritoescolarPeer::getMapBuilder());
