...
abstract class BaseConceptobajaPeer {
	...
	public static function getMapBuilder()
	{
		if (self::$mapBuilder === null) {
			self::$mapBuilder = new ConceptobajaMapBuilder();
		}
	...
	public static function doCount(Criteria $criteria, $distinct = false, PropelPDO $con = null)
	{
				$criteria = clone $criteria;
								...
								$criteria->setPrimaryTableName(ConceptobajaPeer::TABLE_NAME);
	...
	{
		return ConceptobajaPeer::populateObjects(ConceptobajaPeer::doSelectStmt($criteria, $con));
	}
	...
	public static function removeInstanceFromPool($value)
	{
		if (Propel::isInstancePoolingEnabled() && $value !== null) {
			if (is_object($value) && $value instanceof Conceptobaja) {
				$key = (string) $value->getId();
			} elseif (is_scalar($value)) {
								$key = (string) $value;
			} else {
				$e = new PropelException("Invalid value passed to removeInstanceFromPool().  Expected primary key or Conceptobaja object; got " . (is_object($value) ? get_class($value) . ' object.' : var_export($value,true)));
				throw $e;
			}
	...
	public static function populateObjects(PDOStatement $stmt)
	{
		...
		$cls = substr('.'.$cls, strrpos('.'.$cls, '.') + 1);
			...
			$key = ConceptobajaPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj = ConceptobajaPeer::getInstanceFromPool($key))) {
																$results[] = $obj;
			} else {
				...
				$obj->hydrate($row);
				$results[] = $obj;
				ConceptobajaPeer::addInstanceToPool($obj, $key);
			} 		}
		$stmt->closeCursor();
		return $results;
	}
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(ConceptobajaPeer::ID) && $criteria->keyContainsValue(ConceptobajaPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.ConceptobajaPeer::ID.')');
		}
	...
	public static function doDeleteAll($con = null)
	{
	 ...
	 public static function doDelete($values, PropelPDO $con = null)
	 {
		...
		if ($values instanceof Criteria) {
												ConceptobajaPeer::clearInstancePool();

						$criteria = clone $values;
		} elseif ($values instanceof Conceptobaja) {
						ConceptobajaPeer::removeInstanceFromPool($values);
			...
			foreach ((array) $values as $singleval) {
								ConceptobajaPeer::removeInstanceFromPool($singleval);
			}
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		if (null !== ($obj = ConceptobajaPeer::getInstanceFromPool((string) $pk))) {
			return $obj;
		}
...
Propel::getDatabaseMap(BaseConceptobajaPeer::DATABASE_NAME)->addTableBuilder(BaseConceptobajaPeer::TABLE_NAME, BaseConceptobajaPeer::getMapBuilder());
