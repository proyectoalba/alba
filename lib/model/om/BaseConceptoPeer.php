...
abstract class BaseConceptoPeer {
	...
	public static function doCountJoinEstablecimiento(Criteria $criteria, $distinct = false, $con = null)
	{
		...
		$criteria->addJoin(ConceptoPeer::FK_ESTABLECIMIENTO_ID, EstablecimientoPeer::ID);
	...
	public static function doSelectJoinEstablecimiento(Criteria $c, $con = null)
	{
		...
		$startcol = (ConceptoPeer::NUM_COLUMNS - ConceptoPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
		EstablecimientoPeer::addSelectColumns($c);

		$c->addJoin(ConceptoPeer::FK_ESTABLECIMIENTO_ID, EstablecimientoPeer::ID);
	...
	public static function doSelectJoinAll(Criteria $c, $con = null)
	{
		...
		ConceptoPeer::addSelectColumns($c);
		$startcol2 = (ConceptoPeer::NUM_COLUMNS - ConceptoPeer::NUM_LAZY_LOAD_COLUMNS) + 1;
