...
abstract class BaseConceptoPeer {
	...
	public static function addSelectColumns(Criteria $criteria)
	{
		...
		$criteria->addSelectColumn(ConceptoPeer::ID);

		$criteria->addSelectColumn(ConceptoPeer::FK_ESTABLECIMIENTO_ID);

		$criteria->addSelectColumn(ConceptoPeer::NOMBRE);

		$criteria->addSelectColumn(ConceptoPeer::DESCRIPCION);
	...
	public static function doCountJoinEstablecimiento(Criteria $criteria, $distinct = false, PropelPDO $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$criteria->addJoin(array(ConceptoPeer::FK_ESTABLECIMIENTO_ID,), array(EstablecimientoPeer::ID,), $join_behavior);
	...
	public static function doSelectJoinEstablecimiento(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		$startcol = (ConceptoPeer::NUM_COLUMNS - ConceptoPeer::NUM_LAZY_LOAD_COLUMNS);
		EstablecimientoPeer::addSelectColumns($c);

		$c->addJoin(array(ConceptoPeer::FK_ESTABLECIMIENTO_ID,), array(EstablecimientoPeer::ID,), $join_behavior);
		$stmt = BasePeer::doSelect($c, $con);
		$results = array();

		while ($row = $stmt->fetch(PDO::FETCH_NUM)) {
			$key1 = ConceptoPeer::getPrimaryKeyHashFromRow($row, 0);
			if (null !== ($obj1 = ConceptoPeer::getInstanceFromPool($key1))) {
															} else {
				...
				$obj1 = new $cls();
				$obj1->hydrate($row);
				ConceptoPeer::addInstanceToPool($obj1, $key1);
			} 
	...
	public static function doSelectJoinAll(Criteria $c, $con = null, $join_behavior = Criteria::LEFT_JOIN)
	{
		...
		ConceptoPeer::addSelectColumns($c);
		$startcol2 = (ConceptoPeer::NUM_COLUMNS - ConceptoPeer::NUM_LAZY_LOAD_COLUMNS);
  ...
  static public function getUniqueColumnNames()
  {
	...
	public static function doInsert($values, PropelPDO $con = null)
	{
		...
		if ($criteria->containsKey(ConceptoPeer::ID) && $criteria->keyContainsValue(ConceptoPeer::ID) ) {
			throw new PropelException('Cannot insert a value for auto-increment primary key ('.ConceptoPeer::ID.')');
		}
	...
	public static function retrieveByPK($pk, PropelPDO $con = null)
	{
		...
		$criteria->add(ConceptoPeer::ID, $pk);
	...
	public static function retrieveByPKs($pks, PropelPDO $con = null)
	{
		...
		if (empty($pks)) {
			...
			$criteria = new Criteria(ConceptoPeer::DATABASE_NAME);
			$criteria->add(ConceptoPeer::ID, $pks, Criteria::IN);
