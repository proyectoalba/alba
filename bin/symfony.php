...
define('PAKEFILE_LIB_DIR',  dirname(__FILE__).'/../lib');
define('PAKEFILE_DATA_DIR', dirname(__FILE__).'/../data');
define('PAKEFILE_SYMLINK',  false);
define('SYMFONY_VERSION',   '0.6.2');

require_once dirname(__FILE__).'/pake.php';
